    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                i.world /= 30;
                i.world.xy += float2(_OffsetX, _OffsetY) / 15;

                pos.x = floor(frac((i.world.x - 0.5 * _Thickness) * localScale) + _Thickness * localScale);
                pos.y = floor(frac((i.world.y - 0.5 * _Thickness) * localScale) + _Thickness * localScale);
                ...
                {
                    pos.x = floor(frac((i.world.x - 0.5 * _Thickness) * 10.0 * localScale) + _Thickness * 10.0 * localScale);
                    pos.y = floor(frac((i.world.y - 0.5 * _Thickness) * 10.0 * localScale) + _Thickness * 10.0 * localScale);
